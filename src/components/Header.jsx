...
const Header = () => {
    ...
    return (
        <header className={` ${navbar ? 'backdrop-blur-sm bg-black bg-opacity-60 transition-all duration-700 border-b-neutral-80 border-b-[1px]' : 'bg-transparent'} fixed top-0 w-full h-16 md:w-full max-md:h-14 z-40`}>
